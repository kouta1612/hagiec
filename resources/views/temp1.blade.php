...
<div class="container">
  <div class="row">
    <div class="col-12 text-center">
                  ...
                  <div class="col-4">
                    <div class="address-body">
                      <form class="form-group" method="post" action="/confirm">
                        ...
                        <input id="select_id_{{address->id}}" type="hidden" name="id" value="{{$address->id}}">
                        <button class="btn btn-primary mt-3" type="submit" name="button">この住所を使う</button>
                      </form>
                    </div>
                  </div>
      ...
      {{--モーダル表示部分--}}
      <form id="post" class="form-group" action="/done_payment" method="post">
    ...
    <div class="col-4">
      ...
      <div class="address-body">
        <ul>
          ...
          <li><input type="hidden" id="selected_id" value="{{$user->selected_address()->id}}"></li>
        </ul>
      </div>
    </div>
